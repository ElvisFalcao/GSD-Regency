...
import { BRAND_CATALOG, createActivationTasks, groupContentTasks } from './automation.js';
...
export function createDataLayer(client, { workspaceId }) {
  ...
  async function importCampaign({ brand, name, market }, rows, { paidMediaOwnerId, resolveRole } = {}) {
